...
!function(){var e=document.getElementById("fomoups-container");e||(e=document.createElement("div"),e.id="fomoups-container",e.className="fomoups-top-right",document.body.appendChild(e));
...
`;document.head.appendChild(t);function o(t){
...
}function n(t){var n=0,i=0,a=0,s=0,r=!1,l=window.innerWidth,c=null,d=.3*l;function u(e){if(e.target.closest(".fomoups-close")) return;c=t.getBoundingClientRect();if("touchstart"===e.type){n=e.touches[0].clientX;i=e.touches[0].clientY}else{n=e.clientX;i=e.clientY}a=0;s=0;r=!0;t.style.transition="none";t.style.zIndex="10001";t.classList.add("fomoups-dragging");}

function p(e){if(r){e.preventDefault();var o,i;"touchmove"===e.type?(o=e.touches[0].clientX,i=e.touches[0].clientY):(o=e.clientX,i=e.clientY);var s=o-n;a=s,t.style.transform="translateX("+a+"px)";var l=Math.min(Math.abs(a)/d,1);t.style.opacity=1-.4*l,Math.abs(a)>d?t.classList.add("fomoups-will-close"):t.classList.remove("fomoups-will-close")}}

function f(n){if(r){r=!1,t.classList.remove("fomoups-dragging");if(Math.abs(a)>d){var i=a>0?"right":"left",s=i==="right"?l-c.left+100:-c.right-100;t.style.transition="all 0.3s ease-out",t.style.transform="translateX("+s+"px)",t.style.opacity="0",setTimeout(function(){t.parentNode===e&&e.removeChild(t)},300)}else t.style.transition="transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275), opacity 0.3s ease",t.style.transform="translateX(0)",t.style.opacity="1",setTimeout(function(){t.style.transition="",t.style.zIndex=""},300)}}t.addEventListener("mousedown",u),t.addEventListener("touchstart",u,{passive:!0}),document.addEventListener("mouseup",f),document.addEventListener("touchend",f),document.addEventListener("mousemove",p),document.addEventListener("touchmove",p,{passive:!1}),window.addEventListener("resize",function(){l=window.innerWidth,d=.3*l})}window.FomoUps={setPosition:function(t){
  e.className="";
  e.classList.add("fomoups-"+t);
},show:function(t,i,a){var s={...{type:"default",icon:["fa-solid","fa-bell"],time:"now",duration:5e3},...a},r=document.createElement("div");r.className="fomoups-notification",s.type&&"default"!==s.type&&r.classList.add("fomoups-"+s.type);var l=document.createElement("div");l.className="fomoups-icon";
...
if (s.imgIcon) {
    ...
    if(Array.isArray(s.icon))s.icon.forEach(function(e){e&&c.classList.add(e)});
    else if("string"==typeof s.icon){s.icon.split(" ").forEach(function(e){e&&c.classList.add(e)})}
    l.appendChild(c);
}

var d=document.createElement("div");d.className="fomoups-content";var u=document.createElement("div");u.className="fomoups-header";var p=document.createElement("div");p.className="fomoups-title",p.textContent=t;var f=document.createElement("div");f.className="fomoups-time",f.textContent=s.time,u.appendChild(p);var m=document.createElement("div");m.className="fomoups-message",m.textContent=i,d.appendChild(u),d.appendChild(m),d.appendChild(f),r.appendChild(l),r.appendChild(d);var y=document.createElement("div");return y.className="fomoups-close",y.innerHTML='<i class="fa-solid fa-xmark"></i>',y.addEventListener("click",function(e){e.stopPropagation(),o(r)}),r.appendChild(y),e.prepend(r),n(r),

s.duration>0&&setTimeout(function(){r.parentNode===e&&o(r)},s.duration),r},clear:function(){for(;e.firstChild;)o(e.firstChild)}},window.showDefault=function(){FomoUps.show("Notification","This is a simple notification message",{type:"default",icon:["fa-solid","fa-bell"]})},window.showTwitter=function(){FomoUps.show("0 likes on your last post","Consider a career shift",{type:"blue",icon:["fa-brands","fa-twitter"],time:"now"})},window.showGym=function(){FomoUps.show("Gym Chad","6 months ago you said tomorrow. Still in couch?",{type:"yellow",icon:["fa-solid","fa-dumbbell"],time:"30d"})},window.showSuccess=function(){FomoUps.show("Payment received","You received a payment of $120.00",{type:"green",icon:["fa-solid","fa-dollar-sign"],time:"1h"})},window.showAlert=function(){FomoUps.show("System Alert","Your account will expire in 3 days",{type:"red",icon:["fa-solid","fa-triangle-exclamation"],time:"important"})},window.showFollow=function(){FomoUps.show("New follower","Someone started following your profile",{type:"purple",icon:["fa-solid","fa-user-plus"],time:"5m"})};
